...
class Preprocessing:
    ...
    def fastp_single_end(self):
        ...
        if fastp_conf['-t'] != None:
            com += '-t ' + str(int(fastp_conf['-t']))+' '
        if fastp_conf['-b'] != None:
            com += '-b ' + str(int(fastp_conf['-b']))+' '
        # if fastp_conf['-F'] != None:
        ...
        if fastp_conf['--poly_g_min_len'] != None:
            com += '--poly_g_min_len' + fastp_conf['--poly_g_min_len']+' '
        if fastp_conf['-G'] != None:
            com += '-G '
        if fastp_conf['--trim_poly_x'] != None:
            com += '--trim_poly_x '
        if fastp_conf['--poly_x_min_len'] != None:
            com += '--poly_x_min_len ' + fastp_conf['--poly_x_min_len']+' '
        ...
        if fastp_conf['--cut_front_window_size'] != None:
            com += "--cut_front_window_size " +str(int(fastp_conf['--cut_front_window_size']))+' '
        ...
        if fastp_conf['--length_required'] != None:
            com += "--length_required %s " % fastp_conf['--length_required']
        ...
        if fastp_conf['--complexity_threshold'] != None:
            com += "--complexity_threshold %s " % fastp_conf['--complexity_threshold']
        ...
        if fastp_conf['--filter_by_index_threshold'] != None:
            com += "--filter_by_index_threshold %s " % fastp_conf['--filter_by_index_threshold']
    ...
    def trimmomatic_single_end(self):
        ...
        path_to_trimmomatic = os.path.join(os.path.join(os.path.dirname(os.path.realpath(__file__)),'softwares'),'trimmomatic-0.39.jar')
        com = 'java -jar '+path_to_trimmomatic+' SE '
        # com = 'trimmomatic SE '
    ...
    def trimmomatic_paired_end(self):
        ...
        trimmomatic_conf = self.conf['preprocessing']['trimmomatic']
        com = 'java -jar '+path_to_trimmomatic+' PE '
        # com = 'trimmomatic PE '
        if trimmomatic_conf['-threads'] != None:
            com += "-threads %s " % int(trimmomatic_conf['-threads'])
        if trimmomatic_conf['-phred33'] != None:
